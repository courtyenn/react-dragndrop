...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_main.MainSection, null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LineItem = __webpack_require__(96);

	var _LineItem2 = _interopRequireDefault(_LineItem);

	var _reactDragndrop = __webpack_require__(97);

	var _DropTargetStyles = __webpack_require__(276);

	var _DropTargetStyles2 = _interopRequireDefault(_DropTargetStyles);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	console.log(_reactDragndrop.DragDropManager);
	var dragDropManager = new _reactDragndrop.DragDropManager();
	...
	var MainSection = function (_React$Component) {
	    ...
	    function MainSection() {
	        ...
	        var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(MainSection).call(this));
	    ...
	    (0, _createClass3.default)(MainSection, [{
	        ...
	        value: function renderDropTargets() {
	            var list = _react2.default.createElement(_List2.default, { title: "hello world" });
	            ...
	            var dropTargetComponents = this.dropTargets.map(function (dropTarget, index) {
	                return _react2.default.createElement(_reactDragndrop.DropTarget, (0, _extends3.default)({
	        ...
	        value: function renderDroppables() {
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        _LineItem2.default,
	                        { key: "0.0.1", style: this.style, width: 500, height: 500 },
	                        'Edible'
	                    )
	                ),
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        _LineItem2.default,
	                        { key: "0.0.2", style: this.style, width: 500, height: 500 },
	                        'Cuddly'
	                    )
	                )
	            );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LineItem = function (_Component) {
	    ...
	    function LineItem() {
	        ...
	        return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(LineItem).apply(this, arguments));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _setPrototypeOf3 = __webpack_require__(88);
	...
	var _preventExtensions = __webpack_require__(105);

	var _preventExtensions2 = _interopRequireDefault2(_preventExtensions);

	var _isExtensible = __webpack_require__(108);
	...
	var _symbol3 = __webpack_require__(73);

	var _symbol4 = _interopRequireDefault2(_symbol3);

	var _assign3 = __webpack_require__(5);

	var _assign4 = _interopRequireDefault2(_assign3);

	var _getPrototypeOf3 = __webpack_require__(42);
	...
	var _create3 = __webpack_require__(92);

	var _create4 = _interopRequireDefault2(_create3);

	var _defineProperty3 = __webpack_require__(49);

	var _defineProperty4 = _interopRequireDefault2(_defineProperty3);

	var _typeof5 = __webpack_require__(53);
	...
	(function webpackUniversalModuleDefinition(root, factory) {
		if (( false ? 'undefined' : (0, _typeof6.default)(exports)) === 'object' && ( false ? 'undefined' : (0, _typeof6.default)(module)) === 'object') module.exports = factory(__webpack_require__(119));else if (true) !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(119)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));else {
			var a = (typeof exports === 'undefined' ? 'undefined' : (0, _typeof6.default)(exports)) === 'object' ? factory(require("React")) : factory(root["React"]);
			for (var i in a) {
				((typeof exports === 'undefined' ? 'undefined' : (0, _typeof6.default)(exports)) === 'object' ? exports : root)[i] = a[i];
			}
		}
	})(undefined, function (__WEBPACK_EXTERNAL_MODULE_99__) {
		return (/******/function (modules) {
			...
			/***/function (module, exports, __webpack_require__) {
				...
				var _DragDropManager = __webpack_require__(1);
			...
			/***/function (module, exports, __webpack_require__) {
				...
				var _boxBoundaryChecking = __webpack_require__(60);
				...
				var DragDropManager = function () {
					function DragDropManager() {
						(0, _classCallCheck3.default)(this, DragDropManager);
					...
					(0, _createClass3.default)(DragDropManager, [{
						...
						value: function draggableIsOverDropTarget(draggable) {
							...
							try {
								for (var _iterator = (0, _getIterator3.default)(this.dropTargets), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
									...
									draggable.isOverTarget = (0, _boxBoundaryChecking.checkBoundaries)(draggableDimensions, dropTargetDimensions);
			...
			/***/function (module, exports, __webpack_require__) {
				...
				exports.f = __webpack_require__(25) ? _defineProperty4.default : function defineProperty(O, P, Attributes) {
					anObject(O);
					P = toPrimitive(P, true);
					anObject(Attributes);
					if (IE8_DOM_DEFINE) try {
			...
			/***/function (module, exports, __webpack_require__) {
				...
				module.exports = __webpack_require__(25) ? _defineProperties2.default : function defineProperties(O, Properties) {
					anObject(O);
					var keys = getKeys(Properties),
					    length = keys.length,
					    i = 0,
			...
			/***/function (module, exports, __webpack_require__) {
				...
				var Draggable = function (_Component) {
					...
					function Draggable() {
						...
						var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(Draggable).call(this));
					...
					(0, _createClass3.default)(Draggable, [{
						...
						value: function componentWillMount() {
							...
							this.style = (0, _assign2.default)({}, this.style, { width: this.width, height: this.height });
						}
					}, {
						...
						value: function render() {
							...
							var draggableClone = _react2.default.Children.map(this.props.children, function (child) {
								var childStyle = '';
								if (child && child.props && child.props.style) {
									childStyle = child.props.style;
								}
								return _react2.default.createElement('div', {
									style: (0, _assign2.default)({}, _this2.style, style, childStyle),
									key: _this2.props.id,
							...
							return _react2.default.createElement("div", null, draggableClone);
						}
					}, {
						key: "setMousePosition",
						value: function setMousePosition(ev) {
						...
						value: function hideDraggable() {
							this.style = (0, _assign2.default)(this.style, { visibility: 'hidden' });
			...
			/***/function (module, exports, __webpack_require__) {
				...
				module.exports = {
					...
					function (test, buggy, set) {
						try {
							set = __webpack_require__(18)(Function.call, __webpack_require__(87).f(Object.prototype, '__proto__').set, 2);
							set(test, []);
							buggy = !(test instanceof Array);
						} catch (e) {
							buggy = true;
			...
			/***/function (module, exports, __webpack_require__) {
				...
				var DropTarget = function (_Component) {
					(0, _inherits3.default)(DropTarget, _Component);

					function DropTarget() {
						(0, _classCallCheck3.default)(this, DropTarget);

						var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(DropTarget).call(this));
					...
					(0, _createClass3.default)(DropTarget, [{
						key: "componentWillMount",
						value: function componentWillMount() {
						...
						value: function render() {
							...
							if (this.props.style) {
								style = (0, _assign2.default)({}, this.style, this.props.style);
							}

							var type = (0, _typeof3.default)(this.props.wrapper);
							if (type === "string") {
								var innards = _react2.default.createElement(this.wrapper, null, this.content);
								dropTargetElement = _react2.default.createElement("div", { style: style }, innards);
							}
							...
							if (type === "object") {
								...
								dropTargetElement = _react2.default.createElement("div", { style: style }, wrapper);
							}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(10).Object.preventExtensions;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(10).Object.isExtensible;
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.S + $export.F * !__webpack_require__(18), 'Object', {defineProperties: __webpack_require__(64)});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactPerf = __webpack_require__(136);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactElement = __webpack_require__(160);
	var ReactEmptyComponentRegistry = __webpack_require__(162);
	var ReactInstanceHandles = __webpack_require__(163);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactElement = __webpack_require__(160);
	var ReactElementValidator = __webpack_require__(272);
	var ReactPropTypes = __webpack_require__(225);
	var ReactVersion = __webpack_require__(264);
